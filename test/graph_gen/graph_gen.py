...
for my_iter in range(0, 50):
	...
	with open("test/graph_gen/graph.config","r") as f:
		config = f.readlines()
	...
	path1 = "test/resource_BW.csv"
	path2 = "test/task_connectivity_" + str(my_iter) + ".csv"
	path3 = "test/task_exe_time_" + str(my_iter) + ".csv"
